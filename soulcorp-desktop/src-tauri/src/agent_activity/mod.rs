...
pub use emitter::{
    emit_autopilot_phase_change, emit_deliverable_ready, emit_error, emit_step_complete,
    emit_step_start, emit_terminal_line, emit_token_delta, emit_worker_message, end_session,
    max_events, resolve_brain_labels, snapshot, start_session,
};
pub use types::{
